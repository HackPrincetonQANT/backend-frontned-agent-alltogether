...
1. First think through the problem, read the codebase for relevant files, and write a plan to tmp/claude/todo.md
...
11. Keep all temporary files you create under tmp/claude/ dir
